...
public interface IDhcpLeaseEngine
{
    ...
    Task<DhcpLease> AllocateAsync(PhysicalAddress mac, TimeSpan leaseTime);
    Task<DhcpLease> AllocateWithArpCheckAsync(PhysicalAddress mac, TimeSpan leaseTime, IArpConflictDetector arp);
