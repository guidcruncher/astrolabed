...
public interface IDhcpLeaseEngine
{
    ...
    Task<DhcpLease> AllocateAsync(string clientName, PhysicalAddress mac, TimeSpan leaseTime);
    Task<DhcpLease> AllocateWithArpCheckAsync(string clientName, PhysicalAddress mac, TimeSpan leaseTime, IArpConflictDetector arp);
