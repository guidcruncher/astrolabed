...
{
    private readonly CrossPlatformScannerOptions _options;
    private readonly ILogger<CrossPlatformLanScannerService> _logger;

    public CrossPlatformLanScannerService(
        IOptions<CrossPlatformScannerOptions> options,
        ILogger<CrossPlatformLanScannerService> logger)
    {
